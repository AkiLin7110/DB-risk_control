...
def get_data3(lastet_month:str):
    '''lastest_month: 11308'''
    payload = {
    '__EVENTTARGET':'', 
    '__EVENTARGUMENT': '',
...
def get_data9_1(query):
    ...
    driver = webdriver.Chrome()
    driver.maximize_window()
    driver.get(f'https://www.lme.com/Metals/Ferrous/{query}#Trading+day+summary')
    time.sleep(1)
...
# if __name__ == '__main__':
    ...
    # GEO = 'IN'
    # df = get_data2(GEO)
    # df.to_excel(f'new_data/2_google_{GEO}.xlsx')
